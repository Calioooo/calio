...
struct URLSessionGroupSpaceRepository: GroupSpaceRepository {
    ...
    func fetchGroupSpace(groupSpaceId: Int64) async throws -> GroupSpaceResponseDTO { try await apiClient.send(GroupSpaceResponseDTO.self, method: .get, pathComponents: ["api", "group-spaces", String(groupSpaceId)], authorization: .bearer) }
