...
struct StubEventRepository: EventRepository, TagRepository {
  ...
  func createRecurrenceEvent(_ request: CreateRecurrenceEventRequestDTO) async throws
  ...
  private func sampleEvents(around baseDate: Date) -> [EventResponseDTO] {
    [
      makeEvent(
        id: 1, dayOffset: 1, hour: 12, minute: 0, durationMinutes: 60, title: "점심 약속",
        description: "외부 미팅", from: baseDate),
      makeEvent(
        id: 2, dayOffset: 1, hour: 17, minute: 0, durationMinutes: 60, title: "릴리즈 체크",
        description: "배포 전 확인", from: baseDate),
      makeEvent(
        id: 3, dayOffset: 1, hour: 19, minute: 30, durationMinutes: 60, title: "팀 미팅",
        description: "주간 일정 공유", from: baseDate),
      makeEvent(
        id: 4, dayOffset: 0, hour: 13, minute: 0, durationMinutes: 90, title: "제품 리뷰",
        description: "캘린더 화면 구조 확인", from: baseDate),
      makeEvent(
        id: 5, dayOffset: 1, hour: 10, minute: 0, durationMinutes: 30, title: "1:1 미팅",
        description: "진행 상황 확인", from: baseDate),
      makeEvent(
        id: 6, dayOffset: 1, hour: 15, minute: 30, durationMinutes: 60, title: "API 계약 정리",
        description: "Event 조회 응답 필드 확인", from: baseDate),
      makeEvent(
        id: 7, dayOffset: 2, hour: 8, minute: 0, durationMinutes: 45, title: "운동",
        description: "아침 운동", from: baseDate),
      makeEvent(
        id: 8, dayOffset: 3, hour: 11, minute: 0, durationMinutes: 120, title: "기획 회의",
        description: "다음 스프린트 범위 논의", from: baseDate),
      makeEvent(
        id: 9, dayOffset: 5, hour: 18, minute: 30, durationMinutes: 90, title: "저녁 약속",
        description: "개인 일정", from: baseDate),
      makeEvent(
        id: 10, dayOffset: 7, hour: 14, minute: 0, durationMinutes: 60, title: "디자인 리뷰",
        description: "날짜 Strip 상태 확인", from: baseDate),
      makeEvent(
        id: 11, dayOffset: 1, hour: 20, minute: 0, durationMinutes: 60, title: "점심 약속",
        description: "외부 미팅", from: baseDate),
      makeEvent(
        id: 12, dayOffset: 1, hour: 21, minute: 0, durationMinutes: 60, title: "릴리즈 체크",
        description: "배포 전 확인", from: baseDate),
      makeEvent(
        id: 13, dayOffset: 1, hour: 22, minute: 30, durationMinutes: 60, title: "팀 미팅",
        description: "주간 일정 공유", from: baseDate),
    ]
  }
