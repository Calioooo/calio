...
struct EventServiceTests {
  ...
  @Test func allDayDisplayRangePreservesBackendUTCDateAcrossDeviceTimeZones() throws {
    ...
    #expect(
      CalendarDateService.localDateString(from: range.startAt, calendar: newYorkCalendar)
        == "2026-07-18")
    #expect(
      CalendarDateService.localDateString(from: range.endAt, calendar: newYorkCalendar)
        == "2026-07-22")
  }
