...
struct EventCreationTests {
  ...
  @Test func eventCreationDefaultTimesUseReferenceDayMorningRange() async throws {
    ...
    let referenceDate = try #require(
      calendar.date(from: DateComponents(year: 2026, month: 6, day: 10, hour: 15)))
    let referenceDay = DayKey(date: referenceDate, calendar: calendar)

    let range = CalendarEventCreationView.defaultTimeRange(
      referenceDay: referenceDay, calendar: calendar)
    let startComponents = calendar.dateComponents(
      [.year, .month, .day, .hour, .minute], from: range.startAt)
    let endComponents = calendar.dateComponents(
      [.year, .month, .day, .hour, .minute], from: range.endAt)
  ...
  @Test func eventCreationSaveValidationAllowsBlankTitleAndRequiresValidTimeRange() async throws {
    ...
    #expect(
      CalendarEventFormRules.canSave(
        title: String(repeating: "😀", count: 80), startAt: startAt, endAt: endAt))
    #expect(
      !CalendarEventFormRules.canSave(
        title: String(repeating: "😀", count: 81), startAt: startAt, endAt: endAt))
    #expect(!CalendarEventFormRules.canSave(title: "회의", startAt: startAt, endAt: startAt))
    #expect(
      !CalendarEventFormRules.canSave(
        title: "회의", startAt: startAt, endAt: startAt.addingTimeInterval(-1)))
  }
  ...
  @Test func eventCreationSaveValidationChecksRecurrenceEndDateWithUTCDate() async throws {
    ...
    let startAt = try #require(
      kstCalendar.date(from: DateComponents(year: 2026, month: 8, day: 1, hour: 9)))
    let endAt = try #require(
      kstCalendar.date(from: DateComponents(year: 2026, month: 8, day: 1, hour: 10)))
    let sameUTCDate = startAt
    let previousUTCDate = try #require(
      kstCalendar.date(from: DateComponents(year: 2026, month: 7, day: 31, hour: 8)))
  ...
  @Test func localEventTextParserEvalCasesMatchExpectedDrafts() async throws {
    ...
    let cases: [LocalEventTextParserEvalCase] = [
      LocalEventTextParserEvalCase(
        ...
        title: "회의",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 15, hour: 15))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 15, hour: 16)))
      ),
      LocalEventTextParserEvalCase(
        text: "오늘 14:00-15:30 디자인 리뷰",
        title: "디자인 리뷰",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 14))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 15, minute: 30)))
      ),
      LocalEventTextParserEvalCase(
        text: "모레 오전 10시 병원",
        title: "병원",
        ...
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 16, hour: 11)))
      ),
      LocalEventTextParserEvalCase(
        text: "다음주 월요일 7시 스탠드업",
        title: "스탠드업",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 20, hour: 7))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 20, hour: 8)))
      ),
      LocalEventTextParserEvalCase(
        text: "금요일 저녁 7시 약속",
        title: "약속",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 17, hour: 19))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 17, hour: 20)))
      ),
      LocalEventTextParserEvalCase(
        ...
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 20, hour: 15)))
      ),
      LocalEventTextParserEvalCase(
        text: "8/3 09:30 면담",
        title: "면담",
        ...
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 8, day: 3, hour: 10, minute: 30)))
      ),
      LocalEventTextParserEvalCase(
        text: "20일 11시 미팅",
        title: "미팅",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 20, hour: 11))),
        endAt: try #require(
      ...
      LocalEventTextParserEvalCase(
        ...
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 11))),
      ...
      LocalEventTextParserEvalCase(
        ...
        title: "약속",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 19))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 20)))
      ),
      LocalEventTextParserEvalCase(
        text: "매월 20일 오후 4시 정산",
        title: "정산",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 20, hour: 16))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 20, hour: 17))),
      ...
      LocalEventTextParserEvalCase(
        ...
        title: "회식",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 16, hour: 18))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 16, hour: 19)))
      ),
      LocalEventTextParserEvalCase(
      ...
      LocalEventTextParserEvalCase(
        ...
        title: "배포 점검",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 0))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 1)))
      ),
      LocalEventTextParserEvalCase(
        text: "오늘 오후 12시 점심",
        title: "점심",
        ...
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 14, hour: 13)))
      ),
      LocalEventTextParserEvalCase(
        text: "12월 31일 밤 11시 송년회",
        title: "송년회",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 12, day: 31, hour: 23))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2027, month: 1, day: 1, hour: 0)))
      ),
      LocalEventTextParserEvalCase(
        text: "1/2 오전 9시 신년 계획",
        title: "신년 계획",
        startAt: try #require(
          calendar.date(from: DateComponents(year: 2027, month: 1, day: 2, hour: 9))),
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2027, month: 1, day: 2, hour: 10)))
      ),
      LocalEventTextParserEvalCase(
        text: "매년 8/3 9시 생일",
        title: "생일",
      ...
      LocalEventTextParserEvalCase(
        ...
        endAt: try #require(
          calendar.date(from: DateComponents(year: 2026, month: 7, day: 17, hour: 15))),
        recurrenceFrequency: .weekly
      ),
      LocalEventTextParserEvalCase(
        text: "7/18-7/21 여행",
    ...
    for testCase in cases {
      ...
      #expect(
        result.recurrenceFrequency == testCase.recurrenceFrequency,
        "recurrence mismatch: \(testCase.text)")
  ...
  @Test func localEventTextParserDateRangesHandleYearRolloverAndRejectInvalidRanges() async throws {
    ...
    #expect(
      yearRollover.startAt == calendar.date(from: DateComponents(year: 2026, month: 12, day: 30)))
  ...
  @Test func localEventTextParserTreatsDateWithoutTimeAsAllDay() async throws {
    ...
    #expect(
      relativeDate.startAt == calendar.date(from: DateComponents(year: 2026, month: 7, day: 15)))
    #expect(
      relativeDate.endAt == calendar.date(from: DateComponents(year: 2026, month: 7, day: 16)))
    #expect(relativeDate.isAllDay)

    let explicitDate = try #require(parser.parse("7월 18일 여행 준비", referenceDate: referenceDate))
    #expect(
      explicitDate.startAt == calendar.date(from: DateComponents(year: 2026, month: 7, day: 18)))
    #expect(
      explicitDate.endAt == calendar.date(from: DateComponents(year: 2026, month: 7, day: 19)))
  ...
  @Test func localEventTextParserRejectsUnsupportedAmbiguousExpressions() async throws {
    ...
    for text in unsupportedTexts {
      #expect(
        parser.parse(text, referenceDate: referenceDate) == nil,
        "unsupported expression should not be parsed: \(text)")
    }
  }
  ...
  @Test func quickEventCreationDraftUsesParsedValuesForRecurringSubmission() async throws {
    ...
    #expect(
      draft.recurrenceInput.endDate
        == calendar.date(from: DateComponents(year: 2027, month: 7, day: 20, hour: 10)))
