...
public interface GoogleCalendarConnectionRepository
  ...
  @Query(
      """
            ...
            """)
  Optional<GoogleCalendarConnection> findByIdWithIntegration(
  ...
  @Query(
      """
            ...
            where integration.accountId = :accountId
            """)
  Optional<GoogleCalendarConnection> findSingleConnectionByAccountIdForUpdate(
  ...
  @Query(
      """
            ...
            where integration.accountId = :accountId
              and connection.state = com.calio.calendar.integration.connection.domain.GoogleCalendarConnectionState.CONNECTED
            """)
  Optional<GoogleCalendarConnection> findConnectedByAccountIdForUpdate(
      @Param("accountId") Long accountId);
  ...
  List<Long> findConnectedAccountIdsAfter(
      @Param("lastAccountId") Long lastAccountId, Pageable pageable);
