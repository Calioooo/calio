...
public interface GoogleCalendarRecurrenceEventMappingRepository
  ...
  boolean existsByRecurrenceEvent_IdAndIntegration_AccountId(
  ...
  Optional<GoogleCalendarRecurrenceEventMapping>
      findByIntegration_IdAndCalendarKeyAndExternalEventId(
          Long integrationId, String calendarKey, String externalEventId);
  ...
  @Query(
      """
            ...
            order by mapping.id
            """)
  List<GoogleCalendarRecurrenceEventMapping> findNextBatchWithRecurrenceEventByIntegrationId(
      @Param("integrationId") Long integrationId,
