...
public class GoogleCalendarAccessTokenService {
  ...
  private String refresh(TokenState tokenState) {
    ...
    try {
      ...
      log.warn(
          "Google Calendar connection disconnected after invalid_grant. connectionId={}",
  ...
  protected void persistRefreshedToken(
      TokenState tokenState, String encryptedAccessToken, Instant accessTokenExpiresAt) {
    tokenUpdateTransaction.executeWithoutResult(
        status -> {
          GoogleCalendarConnection connection =
