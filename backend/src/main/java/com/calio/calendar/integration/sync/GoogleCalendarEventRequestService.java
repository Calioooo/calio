...
public class GoogleCalendarEventRequestService {
  ...
  public Optional<GoogleCalendarEventResponse> getEvent(
      Long integrationId, String externalEventId, GoogleCalendarSyncRunContext context) {
    try {
  ...
  private GoogleCalendarEventPage listEvents(
      GoogleCalendarSyncMode mode, String nextSyncToken, String pageToken, String accessToken) {
  ...
  private String refreshAccessToken(Long integrationId, GoogleCalendarSyncRunContext context) {
