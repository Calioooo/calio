...
public class GoogleCalendarSyncService {
  ...
  private void synchronize(
      Long jobId, SyncExecution execution, GoogleCalendarSyncRunContext context) {
  ...
  private void synchronizePages(
    ...
    do {
      ...
      pageChangeService.applyNormalizedPage(
          execution.integrationId(), execution.accountId(), normalizedPage);
  ...
  private GoogleCalendarSyncMode modeFor(String nextSyncToken) {
    return nextSyncToken == null ? GoogleCalendarSyncMode.FULL : GoogleCalendarSyncMode.INCREMENTAL;
  }
