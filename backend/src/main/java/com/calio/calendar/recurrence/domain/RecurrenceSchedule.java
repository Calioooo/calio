...
public record RecurrenceSchedule(
    @Column(name = "first_occurrence_start_at", nullable = false) Instant firstOccurrenceStartAt,
    @Column(name = "first_occurrence_end_at", nullable = false) Instant firstOccurrenceEndAt,
  ...
  public static RecurrenceSchedule create(
    ...
    return new RecurrenceSchedule(
        firstOccurrenceStartAt, firstOccurrenceEndAt, Boolean.TRUE.equals(allDay), timeZone);
  }
