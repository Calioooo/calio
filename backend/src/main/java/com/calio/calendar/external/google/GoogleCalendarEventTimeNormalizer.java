...
public class GoogleCalendarEventTimeNormalizer {
  ...
  private NormalizedEventTime normalize(
      GoogleCalendarEventTimeResponse eventTime, String fallbackTimeZone, boolean allowsFallback) {
  ...
  public NormalizedEventSchedule normalizeSchedule(
      GoogleCalendarEventTimeResponse start, GoogleCalendarEventTimeResponse end) {
  ...
  private NormalizedEventTime normalizeTimed(
    ...
    try {
      OffsetDateTime offsetDateTime =
          OffsetDateTime.parse(eventTime.dateTime(), DateTimeFormatter.ISO_DATE_TIME);
  ...
  private NormalizedEventTime normalizeOffsetless(
      String dateTime, ResolvedTimeZone resolvedTimeZone) {
    ...
    return new NormalizedEventTime(
        localDateTime.toInstant(validOffsets.getFirst()), false, resolvedTimeZone.id());
  }

  private ResolvedTimeZone resolveTimeZone(
      String explicitTimeZone, String fallbackTimeZone, boolean allowsFallback) {
  ...
  private void validateScheduleShape(NormalizedEventTime start, NormalizedEventTime end) {
