...
public class GoogleCalendarEventsClient {
  ...
  public Optional<GoogleCalendarEventResponse> getRecurrenceOccurrence(
    ...
    try {
      ...
      return page.items().stream()
          .filter(event -> event.originalStartTime() != null)
  ...
  public boolean delete(String accessToken, String externalEventId, String expectedProviderEtag) {
  ...
  private boolean matchesOrigin(GoogleCalendarEventTimeResponse value, Instant originStartAt) {
