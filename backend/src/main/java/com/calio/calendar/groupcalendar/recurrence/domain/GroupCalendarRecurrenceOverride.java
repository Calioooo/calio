...
public class GroupCalendarRecurrenceOverride extends BaseEntity {
  ...
  private GroupCalendarRecurrenceOverride(
  ...
  public static GroupCalendarRecurrenceOverride active(
    ...
    GroupCalendarRecurrenceOverride override =
        new GroupCalendarRecurrenceOverride(recurrenceEvent, originStartAt);
    override.activate(title, description, schedule);
    return override;
  }

  public static GroupCalendarRecurrenceOverride deleted(
      GroupCalendarRecurrenceEvent recurrenceEvent, Instant originStartAt, Instant deletedAt) {
    GroupCalendarRecurrenceOverride override =
        new GroupCalendarRecurrenceOverride(recurrenceEvent, originStartAt);
