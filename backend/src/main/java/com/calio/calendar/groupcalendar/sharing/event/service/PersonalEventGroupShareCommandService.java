...
import com.calio.calendar.groupcalendar.sharing.event.repository.PersonalEventGroupShareDuplicateException;
...
public class PersonalEventGroupShareCommandService {
    ...
    public PersonalEventGroupShare createShare(PersonalEventGroupShare share) {
        try {
            return shareRepository.createShare(share);
        } catch (PersonalEventGroupShareDuplicateException exception) {
