...
public record GroupCalendarItemResponse(
    ...
    public static GroupCalendarItemResponse from(GroupCalendarEvent event) {
    ...
    public static GroupCalendarItemResponse recurrenceOverride(
        ...
        return new GroupCalendarItemResponse(
                ...
                override.getOriginStartAt(), TagResponse.from(recurrenceEvent.getTag()),
