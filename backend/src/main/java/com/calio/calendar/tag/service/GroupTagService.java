...
public class GroupTagService {
    ...
    public GroupTagService(GroupSpaceQueryService groupSpaceQueryService, GroupMembershipQueryService membershipQueryService, TagRepository tagRepository, TagCommandService tagCommandService) { this.groupSpaceQueryService = groupSpaceQueryService; this.membershipQueryService = membershipQueryService; this.tagRepository = tagRepository; this.tagCommandService = tagCommandService; }
    ...
    @Transactional public void delete(Long accountId, Long groupSpaceId, Long tagId) { membershipQueryService.getActiveMembership(groupSpaceId, accountId); tagCommandService.deleteTag(getCustomTag(groupSpaceId, tagId)); }
