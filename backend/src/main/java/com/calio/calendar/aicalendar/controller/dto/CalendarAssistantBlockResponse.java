...
public record CalendarAssistantBlockResponse<T>(CalendarAssistantBlockType type, List<T> items) {
  ...
  public static CalendarAssistantBlockResponse<CalendarMutationPreviewResponse> mutationPreviews(
    ...
    return new CalendarAssistantBlockResponse<>(
        CalendarAssistantBlockType.MUTATION_PREVIEW, mutationPreviews);
  }
}
