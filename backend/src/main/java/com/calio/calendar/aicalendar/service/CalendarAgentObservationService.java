...
public class CalendarAgentObservationService {
  ...
  public void recordRun(
      String conversationId, String model, String outcome, Duration latency, String errorCode) {
    log.info(
  ...
  public void recordTool(
      String conversationId, String toolName, String outcome, Duration latency, int resultCount) {
    log.info(
        ...
        resultCount);
    meterRegistry
        .timer("ai.calendar.agent.tool", "tool", toolName, "outcome", outcome)
        .record(latency);
  }
}
