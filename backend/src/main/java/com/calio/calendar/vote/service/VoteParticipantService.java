...
public class VoteParticipantService {
  ...
  public VoteParticipantResponse create(
      UUID voteRoomPublicId, CreateVoteParticipantRequest request) {
    return VoteParticipantResponse.from(
        create(voteRoomPublicId, request.nickname(), request.password()));
  }
  ...
  public VoteParticipant create(UUID voteRoomPublicId, String nickname, String password) {
    ...
    VoteRoom voteRoom =
        voteParticipantCommandService.getVoteRoomForParticipantCreation(voteRoomPublicId);
  ...
  public VoteSubmissionResponse submitVotes(UUID voteRoomPublicId, SubmitVoteRequest request) {
    ...
    VoteParticipant lockedParticipant =
        voteParticipantCommandService.getParticipantForVoteSubmission(voteRoomPublicId, nickname);
    List<LocalDate> unavailableDates =
        new LinkedHashSet<>(request.unavailableDates()).stream().sorted().toList();
