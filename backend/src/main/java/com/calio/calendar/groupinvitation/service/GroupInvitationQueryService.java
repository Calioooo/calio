...
public class GroupInvitationQueryService {
  ...
  public GroupInvitationQueryService(GroupInvitationRepository invitationRepository, Clock clock) {
  ...
  public GroupInvitation getInvitationByCredentialHash(
      InvitationCredentialType credentialType, byte[] credentialHash) {
