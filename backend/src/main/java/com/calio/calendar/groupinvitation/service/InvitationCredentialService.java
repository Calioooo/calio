...
public class InvitationCredentialService {
  ...
  public InvitationCredentialService(
      SecureRandom secureRandom, GroupInvitationProperties properties, Environment environment) {
  ...
  public InvitationCredentialPair generatePair() {
    ...
    return new InvitationCredentialPair(
        linkToken, inviteCode, hash(linkToken), hash(normalizeCode(inviteCode)));
  }
