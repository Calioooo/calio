...
import com.calio.calendar.tag.usecase.CreateGroupDefaultTagUseCase;
...
public class GroupSpaceService {
    ...
    private final CreateGroupDefaultTagUseCase createGroupDefaultTagUseCase;
    ...
    public GroupSpaceService(
            ...
            CreateGroupDefaultTagUseCase createGroupDefaultTagUseCase,
        ...
        this.createGroupDefaultTagUseCase = createGroupDefaultTagUseCase;
    ...
    public void delete(Long accountId, Long groupSpaceId) {
        ...
        deleteGroupTagsUseCase.deleteAll(groupSpaceId);
