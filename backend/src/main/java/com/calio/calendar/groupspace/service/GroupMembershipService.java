...
public class GroupMembershipService {
    ...
    private void deactivateMember(
        ...
        cleanupMemberShares(groupSpaceId, member.getAccountId());
    ...
    private void deleteSoleOwnerGroup(GroupSpace groupSpace) {
        cleanupGroupShares(groupSpace.getId());
    ...
    private void cleanupMemberShares(Long groupSpaceId, Long accountId) {
