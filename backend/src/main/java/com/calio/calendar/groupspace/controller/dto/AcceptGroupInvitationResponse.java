...
public record AcceptGroupInvitationResponse(
  ...
  public static AcceptGroupInvitationResponse from(
      GroupJoinResult joinResult, GroupSpace groupSpace, GroupMember membership, int memberCount) {
    ...
    return new AcceptGroupInvitationResponse(
        joinResult, GroupSpaceJoinResponse.from(groupSpace, membership, memberCount), projection);
  }
}
