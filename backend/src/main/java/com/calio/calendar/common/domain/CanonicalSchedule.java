...
public record CanonicalSchedule(Instant startAt, Instant endAt, boolean allDay, String timeZone) {
  ...
  private static void validateAllDay(
      Instant startAt, Instant endAt, String timeZone, ErrorCode errorCode) {
