...
public enum ErrorCode {
  ...
  GROUP_MEMBER_REJOIN_INVITATION_REQUIRED(
      HttpStatus.CONFLICT, "A newer group invitation is required to rejoin."),
  GROUP_OWNER_TRANSFER_REQUIRED(
      HttpStatus.CONFLICT, "Group ownership must be transferred before leaving."),
  ...
  GROUP_INVITATION_GENERATION_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "Group invitation generation failed."),
  GROUP_INVITATION_CREDENTIAL_COLLISION(
      HttpStatus.INTERNAL_SERVER_ERROR, "Group invitation credential collision."),
  GROUP_INVITATION_ISSUE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "Group invitation issue failed."),
  ...
  GROUP_RECURRENCE_EVENT_FORBIDDEN(
      HttpStatus.FORBIDDEN, "Group recurrence event operation is forbidden."),
  INVALID_TAG_COLOR_CODE(HttpStatus.BAD_REQUEST, "Invalid tag color code."),
  RECURRENCE_UPDATE_TIME_RANGE_INVALID(
      HttpStatus.BAD_REQUEST, "Recurrence update time range invalid."),
  ...
  RECURRENCE_OCCURRENCE_LIMIT_EXCEEDED(
      HttpStatus.BAD_REQUEST, "Recurrence occurrence limit exceeded."),
  RECURRENCE_OCCURRENCE_TAG_CHANGE_NOT_SUPPORTED(
      HttpStatus.BAD_REQUEST, "Recurrence occurrence tag change is not supported."),
  VALIDATION_FAILED(HttpStatus.BAD_REQUEST, "Validation failed."),
  GOOGLE_CALENDAR_AUTHORIZATION_CODE_REQUIRED(
      HttpStatus.BAD_REQUEST, "Google Calendar authorization code is required."),
  GOOGLE_CALENDAR_CONFIGURATION_MISSING(
      HttpStatus.INTERNAL_SERVER_ERROR, "Google Calendar integration configuration is missing."),
  ...
  GOOGLE_TOKEN_ENCRYPTION_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "Google token encryption failed."),
  GOOGLE_CALENDAR_INTEGRATION_SAVE_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "Google Calendar integration save failed."),
  ...
  GOOGLE_CALENDAR_SYNC_TOKEN_MISSING(
      HttpStatus.BAD_GATEWAY, "Google Calendar sync token is missing."),
  ...
  EXTERNAL_EVENT_MUTATION_NOT_SUPPORTED(
      HttpStatus.CONFLICT, "External event mutation is not supported."),
  ...
  EXTERNAL_API_UNAVAILABLE(
      HttpStatus.SERVICE_UNAVAILABLE, "External API is temporarily unavailable."),
