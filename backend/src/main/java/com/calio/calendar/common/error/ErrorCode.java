...
public enum ErrorCode {
    ...
    GROUP_OWNER_REQUIRED(HttpStatus.FORBIDDEN, "Group Space owner permission is required."),
    GROUP_SPACE_NOT_FOUND(HttpStatus.NOT_FOUND, "Group Space not found."),
    GROUP_MEMBER_NICKNAME_CONFLICT(HttpStatus.CONFLICT, "Group member nickname is already in use."),
