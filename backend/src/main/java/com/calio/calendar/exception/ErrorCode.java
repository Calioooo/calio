...
public enum ErrorCode {
    ...
    RECURRENCE_UPDATE_START_AT_INVALID(HttpStatus.BAD_REQUEST, "Recurrence update startAt must be an ISO 8601 instant."),
    RECURRENCE_UPDATE_END_AT_REQUIRED(HttpStatus.BAD_REQUEST, "Recurrence update endAt is required."),
    RECURRENCE_UPDATE_END_AT_INVALID(HttpStatus.BAD_REQUEST, "Recurrence update endAt must be an ISO 8601 instant."),
