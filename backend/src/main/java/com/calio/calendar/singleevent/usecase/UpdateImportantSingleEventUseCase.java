...
public class UpdateImportantSingleEventUseCase {
    ...
    public UpdateImportantSingleEventUseCase(SingleEventRepository eventRepository,
            GoogleCalendarEventMappingQueryService eventMappingQueryService, TagQueryService tagQueryService) {
