...
public class SingleEvent extends BaseEntity {
  ...
  @Embedded private SingleEventTitle title;

  @Column(columnDefinition = "TEXT")
  private String description;

  @Embedded private SingleEventSchedule schedule;
  ...
  public SingleEvent(
      ...
      Long accountId) {
    this(
        new SingleEventTitle(title),
        description,
        new SingleEventSchedule(startAt, endAt, allDay, timeZone),
        tagId,
        accountId);
  }

  public void replace(SingleEventTitle title, String description, SingleEventSchedule schedule) {
    this.title = title;
    this.description = description;
    this.schedule = schedule;
  }
