...
class CalendarAiMutationPolicyTest {
  ...
  private final CalendarAiMutationPolicy policy =
  ...
  void givenMaximumEndDate_whenValidateCreateRecurrence_thenAccepts() {
    RecurrenceSchedule schedule = timedSchedule("2026-08-07T09:18:00Z", "2026-08-07T10:18:00Z");

    policy.validateCreateRecurrence(List.of("RRULE:FREQ=WEEKLY;UNTIL=21261231T091800Z"), schedule);
  }

  @Test
  @DisplayName("AI 반복 생성은 종료일 없음과 종일 일정을 허용한다")
  void givenOptionalEndDate_whenValidateCreateRecurrence_thenAccepts() {
    RecurrenceSchedule allDay =
  ...
  void givenTimedUntilOnPreviousUtcDate_whenValidateCreateRecurrence_thenAcceptsLocalStartDate() {
    ...
    policy.validateCreateRecurrence(List.of("RRULE:FREQ=WEEKLY;UNTIL=20260806T103000Z"), schedule);
  }
