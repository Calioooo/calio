...
@SpringBootTest(
    properties = {
      "spring.datasource.url=jdbc:h2:mem:ai-calendar-request-classifier-eval;MODE=MySQL;DB_CLOSE_ON_EXIT=FALSE",
...
class CalendarAssistantRequestClassifierEvalTest {
  ...
  @Autowired private CalendarAssistantRequestClassifier requestClassifier;
  ...
  void givenMessage_whenClassify_thenReturnsExpectedClassification(
      String message, CalendarAssistantRequestClassification expectedClassification) {
    // when
    CalendarAssistantRequestClassification actualClassification =
