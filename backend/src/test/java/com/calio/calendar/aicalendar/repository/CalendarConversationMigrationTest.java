...
class CalendarConversationMigrationTest {
  ...
  @Test
  @DisplayName(
      "AI calendar conversation migration은 account ownership, chronological messages와 cleanup index를 정의한다")
  void migrationDefinesConversationPersistenceContract() throws IOException {
    // when
    String migration =
        new ClassPathResource("db/migration/V22__ai_calendar_conversations.sql")
