...
class GroupCalendarRecurrenceOverrideTest {
  ...
  private static final CanonicalSchedule SCHEDULE =
  ...
  void givenActiveOverride_whenCreated_thenIsNotDeletedAndKeepsSchedule() {
    ...
    GroupCalendarRecurrenceOverride override =
        GroupCalendarRecurrenceOverride.active(null, ORIGIN_START_AT, "회의", "설명", SCHEDULE);
  ...
  void givenDeletedOverride_whenActivated_thenRestoresActiveState() {
    ...
    GroupCalendarRecurrenceOverride override =
        GroupCalendarRecurrenceOverride.deleted(
            null, ORIGIN_START_AT, Instant.parse("2026-08-01T08:00:00Z"));
