...
@SpringBootTest(
    properties = {
      "spring.datasource.url=jdbc:h2:mem:group-space-error-contract-test;MODE=MySQL;DB_CLOSE_ON_EXIT=FALSE",
...
class GroupSpaceErrorContractIntegrationTest {
  ...
  void unexpectedExceptionUsesGlobalProblemDetailContract() throws Exception {
    mockMvc
        .perform(get("/api/group-spaces/error-contract/unexpected"))
  ...
  private void expectProblemDetail(ResultActions actions, ErrorCode errorCode, String instance)
      throws Exception {
    actions
