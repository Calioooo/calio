...
class VoteResultControllerTest {
  ...
  void givenSubmittedAndRegisteredParticipants_whenGetPublicResult_thenReturnsSafeCurrentResult()
      throws Exception {
    ...
    mockMvc
        .perform(get("/api/vote-rooms/{publicId}", voteRoom.getPublicId()).with(anonymous()))
  ...
  void givenCacheBustQuery_whenAnonymousGetsPublicResult_thenReturnsOk() throws Exception {
    mockMvc
        .perform(
            get("/api/vote-rooms/{publicId}", voteRoom.getPublicId())
  ...
  void givenMissingVoteRoom_whenGetPublicResult_thenReturnsNotFound() throws Exception {
    mockMvc
        .perform(get("/api/vote-rooms/{publicId}", UUID.randomUUID()).with(anonymous()))
