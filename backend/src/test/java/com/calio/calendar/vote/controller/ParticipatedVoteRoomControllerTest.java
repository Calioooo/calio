...
class ParticipatedVoteRoomControllerTest {
  ...
  void
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$[0].name").value("제출한 투표"))
        ...
        .andExpect(jsonPath("$[1].name").value("생성하고 참여한 투표"))
        .andExpect(jsonPath("$[1].candidateStartDate").value("2026-08-14"))
        .andExpect(jsonPath("$[1].candidateEndDate").value("2026-08-20"))
