...
class VoteRoomMigrationTest {
  ...
  void givenAccountSchema_whenMigrate_thenCreatesVoteRoomPublicIdAndCreatorConstraints()
      throws Exception {
  ...
  private int columnType(Connection connection, String tableName, String columnName)
      throws Exception {
    DatabaseMetaData metadata = connection.getMetaData();
  ...
  private Set<String> uniqueConstraintNames(Connection connection, String tableName)
      throws Exception {
  ...
  private short importedKeyDeleteRule(
      Connection connection, String tableName, String parentTableName) throws Exception {
    DatabaseMetaData metadata = connection.getMetaData();
