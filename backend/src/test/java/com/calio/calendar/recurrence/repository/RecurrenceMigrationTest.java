  ...
  void givenEmptyLegacyTables_whenMigrate_thenCreatesRfc5545Schema() throws Exception {
    ...
    try (Connection connection = DriverManager.getConnection(url, "sa", "")) {
      ...
      assertThat(columnNames(connection, "RECURRENCE_EVENT_OVERRIDES"))
          .contains(
              "OVERRIDE_TITLE", "OVERRIDE_DESCRIPTION", "OVERRIDE_ALL_DAY", "OVERRIDE_TIME_ZONE");
      ...
      assertThat(isNullable(connection, "RECURRENCE_EVENTS", "FIRST_OCCURRENCE_START_AT"))
          .isFalse();
      ...
      assertThat(isNullable(connection, "RECURRENCE_EVENT_OVERRIDES", "OVERRIDE_DESCRIPTION"))
          .isTrue();
      assertThat(isNullable(connection, "RECURRENCE_EVENT_OVERRIDES", "OVERRIDE_ALL_DAY")).isTrue();
      assertThat(isNullable(connection, "RECURRENCE_EVENT_OVERRIDES", "OVERRIDE_TIME_ZONE"))
          .isTrue();
