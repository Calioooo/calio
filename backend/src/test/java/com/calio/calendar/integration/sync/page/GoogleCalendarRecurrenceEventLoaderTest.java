...
class GoogleCalendarRecurrenceEventLoaderTest {
  ...
  void givenCachedRecurrenceEvent_whenLoad_thenReturnsCachedEvent() {
    ...
    context.rememberRecurrenceEvent("recurrence-event-1", new FoundRecurrenceEvent(expected));

    // when
    Optional<RecurrenceEventUpsert> actual =
        loader.loadRecurrenceEvent(10L, "recurrence-event-1", context);
  ...
  void givenMissingRecurrenceEvent_whenLoadedAgain_thenKeepsMissingResult() {
    ...
    // when
    Optional<RecurrenceEventUpsert> first =
        loader.loadRecurrenceEvent(10L, "recurrence-event-1", context);
    Optional<RecurrenceEventUpsert> second =
        loader.loadRecurrenceEvent(10L, "recurrence-event-1", context);
